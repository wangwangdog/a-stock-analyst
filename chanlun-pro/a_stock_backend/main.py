...
from routes.stock_supplement import router as supplement_router
...
if _frontend_dir.is_dir():
    ...
    app.mount("/a-stock/assets", _NoCacheStaticFiles(directory=str(_frontend_dir / "assets")), name="frontend_assets")
